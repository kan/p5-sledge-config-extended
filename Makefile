# This Makefile is for the Sledge::Config::Extended extension to perl.
#
...
#     DIR => []
#     DISTNAME => q[Sledge-Config-Extended]
#     NAME => q[Sledge::Config::Extended]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Filter::Util::Call=>q[0], ExtUtils::MakeMaker=>q[6.42] }
#     VERSION => q[0.01]
...
NAME_SYM = Sledge_Config_Extended
VERSION = 0.01
...
MAKE = make
FULLEXT = Sledge/Config/Extended
BASEEXT = Extended
PARENT_NAME = Sledge::Config
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Sledge/Config/Extended.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Sledge/Config
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Sledge/Config
...
TO_INST_PM = lib/Sledge/Config/Extended.pm

PM_TO_BLIB = lib/Sledge/Config/Extended.pm \
	blib/lib/Sledge/Config/Extended.pm
...
DISTNAME = Sledge-Config-Extended
DISTVNAME = Sledge-Config-Extended-0.01
...
manifypods : pure_all  \
	lib/Sledge/Config/Extended.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Sledge/Config/Extended.pm $(INST_MAN3DIR)/Sledge::Config::Extended.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Sledge/Config/Extended.pm blib/lib/Sledge/Config/Extended.pm 
